import DOM from'quickdom';import {shorthandSideValue}from'../../helpers.js';import'../../constants/colors.js';import {a as textFieldTemplate}from'../text/template-233e9413.js';var template = textFieldTemplate.extend({
  children: {
    'innerwrap': {
      options: {
        style: {
...
}]);var templates = /*#__PURE__*/Object.freeze({default: template,counter: counter});export{template as a,templates as b,counter as c};