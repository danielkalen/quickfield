...
(function(_this) {
  return (function() {
    ...
    return (function() {
      ...
      var COLOR_BLACK, COLOR_GREEN, COLOR_GREY, COLOR_GREY_LIGHT, COLOR_ORANGE, COLOR_RED, DOM, Dropdown, Field, IS, KEYCODES, Mask, QuickField, REQUIRED_FIELD_METHODS, SVG, SelectField, SimplyBind, TextField, _sim_1897b, _sim_21bfc, _sim_2616e, _sim_274b3, _sim_2ed69, animations, appendAnimationStyles, choiceField, currentID, extend, globalDefaults, helpers, prefix, regex, stringDistance, testChar, validPatternChars;
      _sim_1897b = (function(_this) {
        return function(exports) {
          var module = {exports:exports};
          (function() {
            var CSS, IS, QuickBatch, QuickDom, QuickElement, QuickTemplate, QuickWindow, _sim_28324, _sim_283ba, allowedTemplateOptions, configSchema, extend, extendOptions, fn, getParents, helpers, i, len, parseErrorPrefix, parseTree, pholderRegex, regexWhitespace, shortcut, shortcuts, svgNamespace;
            svgNamespace = 'http://www.w3.org/2000/svg';

            /* istanbul ignore next */
            _sim_283ba = (function(exports){
					var module = {exports:exports};
