...
(function(_this) {
  return (function() {
    ...
    return (function() {
      ...
      var COLOR_BLACK, COLOR_GREEN, COLOR_GREY, COLOR_GREY_LIGHT, COLOR_ORANGE, COLOR_RED, DOM, Dropdown, Field, IS, Mask, QuickField, REQUIRED_FIELD_METHODS, SVG, SimplyBind, _sim_1db18, _sim_1dfdf, _sim_1e5ea, _sim_22eed, _sim_2ed51, animations, appendAnimationStyles, currentID, extend, helpers, prefix, regex, stringDistance, testChar, textField, validPatternChars;
      _sim_22eed = (function(_this) {
        return function(exports) {
          var module = {exports:exports};
          (function() {
            var CSS, IS, QuickBatch, QuickDom, QuickElement, QuickTemplate, _sim_29a3f, _sim_2ab84, allowedTemplateOptions, configSchema, extend, extendOptions, fn, getParents, helpers, i, len, parseErrorPrefix, parseTree, pholderRegex, shortcut, shortcuts, svgNamespace;
            svgNamespace = 'http://www.w3.org/2000/svg';

            /* istanbul ignore next */
            _sim_29a3f = (function(exports){
					var module = {exports:exports};
