import DOM from'quickdom';import {shorthandSideValue}from'./helpers.js';import'./constants/colors.js';import {t as textFieldTemplate}from'./template-689295d2.js';var template = textFieldTemplate.extend({
  children: {
    'innerwrap': {
      options: {
        style: {
