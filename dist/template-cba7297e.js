import DOM from'quickdom';import'./svg/checkmark.js';import'./svg/angleDown.js';import'./svg/caretUp.js';import'./svg/caretDown.js';import plus from'./svg/plus.js';import clone from'./svg/clone.js';import remove from'./svg/remove.js';import COLORS from'./constants/colors.js';import {c as collapseIcons}from'./template-95fee5f5.js';var template = DOM.template(['div', {
  ref: 'field',
  style: {
    position: 'relative',
...
};var templates=/*#__PURE__*/Object.freeze({__proto__:null,'default': template,cloneIcon: cloneIcon,removeIcon: removeIcon,blockGroup: blockGroup,inlineGroup: inlineGroup});export{templates as a,blockGroup as b,cloneIcon as c,inlineGroup as i,removeIcon as r,template as t};