import {Dropdown, Mask} from '../../components'
import REGEX from '../../constants/regex'
import KEYCODES from '../../constants/keyCodes'
import {includes, fuzzyMatch, getIndexOfFirstDiff} from '../../helpers'
...
class TextField extends Field
	...
	_attachBindings_autocomplete: ()-> if @dropdown
		...
		SimplyBind('_value').of(@).to (value)=>
			for choice in @dropdown.choices
				shouldBeVisible = if not value then true else fuzzyMatch(value, choice.label)
	...
	_scheduleCursorReset: ()->
		diffIndex = getIndexOfFirstDiff(@mask.value, @mask.prev.value)
