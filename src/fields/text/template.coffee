...
import {shorthandSideValue, calcPadding, defaultColor, hexToRGBA} from '../../helpers'
	...
	['div'
		...
		['div'
			...
			style:
				...
				left: (field)-> shorthandSideValue(field.settings.padding, 'left') + (field.el.child.icon?.width or 0)
		...
		['div'
			...
			['input'
				...
				style:
					...
					padding: (field)->
						@padding ?= Math.max 0, calcPadding(field.settings.height, 14)-3
		...
		['div'
			...
			['div'
				...
				style:
					...
					backgroundColor: (field)-> defaultColor field.els.innerwrap.styleSafe('backgroundColor',1), 'white'
