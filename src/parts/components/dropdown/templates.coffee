...
exports.container = DOM.template ['div', {
	ref: 'dropdown'
...
exports.option = DOM.template ['div', {
	style:
		display: 'none'
		fontSize: '0'
		color: '#000000'
...
exports.scrollIndicatorUp = DOM.template ['div', {
...
exports.scrollIndicatorDown = DOM.template ['div', {
